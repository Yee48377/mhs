  ...
  return (
    <div className="min-h-screen">
      <header className="mx-auto max-w-6xl px-4 pt-6 sm:px-6">
        <div className="flex flex-col items-center gap-3 rounded-[28px] border border-slate-300/90 bg-white/90 px-4 py-4 sm:flex-row sm:justify-between sm:rounded-full sm:py-3">
